...
# 3. Create 5 text files in dir2 named file1, file2, file3, file4, and file5
  touch dir2/file{1..5}.txt #command executed from the parent directory without changing into dir2
# 4. Append the words "Hello world" to dir2/file3
  echo "Hello World" >> dir2/file3.txt  #command executed from the parent directory without changing into dir2
# 5. Verify that file3 contains the words "hello world" by printing the contents of the file in the terminal
  cat dir2/file3.txt #command executed from the parent directory without changing into dir2
# 6. Delete file4
  rm dir2/file4.txt #command executed from the parent directory without changing into dir2
